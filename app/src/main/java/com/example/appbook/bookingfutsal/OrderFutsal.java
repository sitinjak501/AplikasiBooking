...
public class OrderFutsal {
    ...
    public OrderFutsal(){}
    public OrderFutsal(String nama, String nomorponsel, String tanggalbermain, String jambermain, String lamabermain, String email, String lapangan) {
        this.nama = nama;

...
public class Booking implements Serializable {
    ...
    public Booking(String nama, String nomorponsel, String tanggalbermain, String jambermain, String lamabermain, String email, String status, String harga, String lapangan){
        this.nama = nama;
    ...
    public void setTanggalbermain(String tanggalbermain) {
        this.tanggalbermain = tanggalbermain;
    }
    ...
    public void setJambermain(String jambermain) {
        this.jambermain = jambermain;
    }
    ...
    public void setLamabermain(String lamabermain) {
        this.lamabermain = lamabermain;
    }
